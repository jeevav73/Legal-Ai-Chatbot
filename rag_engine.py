...
def build_prompt(question: str, context_chunks):
    ...
    if truncated_chunks:
        ...
        context_text = "No relevant legal context was found. If this is a legal " \
                        "question, say so instead of guessing. If this is a casual " \
                        "or non-legal question, just answer normally."
